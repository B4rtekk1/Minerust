...
impl State {
    ...
    pub async fn new(window: Window) -> Self {
        ...
        Self {
            ...
            last_inventory_revision: u64::MAX,
            inventory_buffer_size: [0, 0],
            inventory_cursor_vertex_buffer: None,
            inventory_cursor_index_buffer: None,
            uniform_buffer,
            uniform_bind_group,
            ...
            dirty_mesh_queued: rustc_hash::FxHashSet::default(),
            camera,
            ...
            last_hotbar_inventory_revision: u64::MAX,
